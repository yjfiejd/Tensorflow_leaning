# -*- coding:utf8 -*-
# @TIME : 2018/4/28 下午5:23
# @Author : Allen
# @File : tensorflow_12_可视化.py
...
for i in range(2000):
    ...
    if i % 200 == 0:
        ...
        #先抹除在画图
        #Try, except, else用法：https://www.cnblogs.com/lordage/p/5722086.html
        try:
            ax.lines.remove(lines[0]) #第一次运行报错，因为lines第一次没有被赋值
        except Exception:
            pass #第一次报错后，程序到这里，继续执行
        #把预测值与x结合起来画图，用ax.plot()
